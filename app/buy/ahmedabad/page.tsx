      ...
      <section className="border-b border-ink/12 bg-sand/70 py-14 md:py-20">
        <div className="container">
          <nav className="flex flex-wrap items-center gap-2 stamp !text-[11px] text-ink/60" aria-label="Breadcrumb">
            ...
            <span className="text-ink/80">Buy in Ahmedabad</span>
          </nav>
          <p className="kicker mt-12 text-brick">The city, locality by locality · अमदावाद</p>
          <h1 className="display mt-6 text-[clamp(44px,7vw,96px)]">Buy in <em className="text-brick">Ahmedabad.</em></h1>
          <p className="mt-7 max-w-[560px] text-base leading-8 text-ink/65 md:text-lg">
            Six localities mapped so far — each with verified coordinates, RERA-checked inventory, and the context that makes an address make sense.
          </p>
        </div>
      </section>
