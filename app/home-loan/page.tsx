...
export const metadata: Metadata = {
  title: "Home loan EMI calculator — Ahmedabad | Architech",
  description: "Use Architech’s educational Ahmedabad home-loan EMI calculator to explore indicative principal, tenure, rate, interest, and total payable outputs.",
  alternates: { canonical: canonicalUrl("/home-loan/") },
  openGraph: { title: "Home loan EMI calculator — Ahmedabad | Architech", url: canonicalUrl("/home-loan/"), type: "website" },
};
