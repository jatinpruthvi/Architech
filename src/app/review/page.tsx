...
import { FeedbackPage } from "@/screens/PublicParity";
...
export default function Page() {
  ...
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: serializeJsonLd(jsonLd) }} /><FeedbackPage /></>;
}
