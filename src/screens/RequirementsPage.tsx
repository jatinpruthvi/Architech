    ...
    <div className="bg-paper pt-[78px] text-ink">
      <section className="border-b border-ink/12 bg-night py-20 text-cream md:py-32">
        <div className="container grid gap-12 lg:grid-cols-[1fr_0.7fr] lg:items-end">
          ...
          <Reveal delay={120} className="flex flex-col items-start gap-4"><RequirementCapture /><p className="stamp-sm text-cream/55">Free to submit · no public phone number · masked by default</p></Reveal>
        </div>
      </section>
