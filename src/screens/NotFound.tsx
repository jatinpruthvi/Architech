    ...
    <div className="bg-paper pt-[78px] text-ink">
      <section className="container flex min-h-[80vh] flex-col items-center justify-center py-24 text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Link href="/" className="clay-fill btn-sweep motion-press inline-flex items-center gap-2 bg-brick px-8 py-5 stamp font-semibold text-cream"><Compass size={15} /> Back to the start</Link>
          <Link href="/search" className="motion-press inline-flex items-center gap-2 border border-ink/25 px-8 py-5 stamp font-semibold text-ink transition-colors hover:border-brick hover:text-brick">Search homes <ArrowUpRight size={15} /></Link>
        </div>
      </section>
    </div>
  );
