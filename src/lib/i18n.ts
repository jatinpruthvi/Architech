...
export const strings = {
  en: {
    ...
    hero: {
      ...
      search: "Search", buy: "Buy", rent: "Rent", newProjects: "New projects", beginWith: "Begin with —",
      stats: ["homes in the registry", "localities mapped", "cities covered"],
    ...
    locality: {
      ...
      trustTitlePrefix: "Every", trustTitleSuffix: "listing’s RERA status is checked with the applicable state/UT authority when an approved adapter is available.", trustCopy: "Registration numbers, promoter details, and completion status are reviewed before publication — and re-checked when a listing is updated.", verifyCta: "How we verify",
      trust: {
      ...
      fullStudySoon: "This prototype summary comes from the demo registry; source-by-source review is required before production publication.",
    },
    intel: {
      priceKicker: "Evidence, not assertion", pricePosition: "price position",
      basedOn: "Based on {n} active demo buy listings", updatedOn: "Updated",
      ...
      essentialsCopy: "Prototype nearby-place rows are map context, not a verified completeness claim. Production publication requires a cited source or reviewed field measurement.",
      essentialsHonest: "A missing category means no reviewed evidence is available; it is never filled by inference.",
      ...
      noProjectsTitle: "No new launches in this area yet", noProjectsCopy: "When a project is matched to the applicable state/UT RERA authority and clears source review, it is published here with its registration details.",
      noProjectsNote: "Watching the applicable RERA authority",
    },
    listing: {
      ...
      reraDetails: "RERA verification details", reraTooltipKicker: "State/UT authority record (sample)", reraTooltipCopy: "A verified badge requires a match against the authority for the property’s state or UT: registration, promoter, project, and status. Unsupported authorities remain unverified.",
    ...
    property: {
      ...
      badgeDetailsCopy: "A RERA badge requires evidence from the authority applicable to the property’s state or UT and is re-checked on meaningful updates. This preview never substitutes another state’s registry.",
  ...
  hi: {
    ...
    hero: {
      ...
      sub: "भारत के शहरों में घर खोजने का भरोसेमंद तरीक़ा — लागू राज्य/केंद्रशासित प्रदेश RERA संदर्भ, इलाक़े की समझ और स्पष्ट स्रोत।",
      placeholderBuy: "कोई भी शहर, इलाक़ा, पिन कोड या BHK खोजें…",
      placeholderRent: "किराए के लिए शहर, इलाक़ा, पिन कोड या BHK खोजें…",
      search: "खोजें", buy: "ख़रीदें", rent: "किराया", newProjects: "नए प्रोजेक्ट", beginWith: "यहाँ से शुरू करें —",
      stats: ["रजिस्ट्री में घर", "मैप किए इलाक़े", "शहर शामिल"], scroll: "स्क्रॉल करें — शहर खुलता है", demoNote: "आँकड़े इस कॉन्सेप्ट प्रीव्यू के लिए उदाहरणात्मक हैं।",
    },
    ...
    search: {
      ...
      mapLabel: "चुने गए शहर के घरों का नक़्शा", searchArea: "इस क्षेत्र में खोजें", searchingArea: "इस क्षेत्र में खोज रहे हैं", searchingAreaDescription: "लाइव डेटा बिल्ड में दिख रहे नक़्शा क्षेत्र के लिए परिणाम अपडेट होंगे। फ़िल्टर बने रहेंगे।",
      liveCartography: "लाइव कार्टोग्राफी · परिणाम पिन किए", mapCopy: "हमारे हर कवर किए गए शहर का OpenStreetMap डेटा — सूची खोए बिना इलाक़े का आकार समझें।",
    ...
    locality: {
      ...
      trustTitlePrefix: "हर", trustTitleSuffix: "लिस्टिंग का RERA दर्जा लागू राज्य या केंद्रशासित प्रदेश की अथॉरिटी से जाँचा जाता है, जहाँ स्वीकृत अडैप्टर उपलब्ध है।", trustCopy: "प्रकाशन से पहले पंजीकरण संख्या, प्रमोटर विवरण और completion status की समीक्षा होती है — और अपडेट पर दोबारा जाँच होती है।", verifyCta: "हम कैसे सत्यापित करते हैं",
      trust: {
      ...
      fullStudySoon: "यह प्रोटोटाइप सारांश डेमो रजिस्ट्री से है; उत्पादन प्रकाशन से पहले हर स्रोत की समीक्षा ज़रूरी है।",
    },
    intel: {
      priceKicker: "प्रमाण, दावा नहीं", pricePosition: "क़ीमत की स्थिति",
      basedOn: "{n} सक्रिय डेमो ख़रीद लिस्टिंग पर आधारित", updatedOn: "अपडेट",
      ...
      essentialsCopy: "प्रोटोटाइप में आस-पास की जगहें केवल नक़्शा संदर्भ हैं, पूर्णता का सत्यापित दावा नहीं। उत्पादन प्रकाशन के लिए उद्धृत स्रोत या समीक्षित फ़ील्ड माप ज़रूरी है।",
      essentialsHonest: "किसी श्रेणी का न दिखना मतलब समीक्षित प्रमाण उपलब्ध नहीं है; उसे अनुमान से कभी नहीं भरा जाता।",
      readStudy: "इलाक़ा गाइड पढ़ें",
      projectsKicker: "नई लॉन्च", projectsTitle: "नए प्रोजेक्ट —",
      allNewProjects: "सभी नए प्रोजेक्ट",
      noProjectsTitle: "इस क्षेत्र में अभी कोई नई लॉन्च नहीं", noProjectsCopy: "जब कोई प्रोजेक्ट लागू राज्य या केंद्रशासित प्रदेश RERA अथॉरिटी से मेल खाता है और स्रोत समीक्षा पूरी करता है, तभी विवरण यहाँ प्रकाशित होता है।",
      noProjectsNote: "लागू RERA अथॉरिटी पर नज़र",
    },
    listing: {
      ...
      reraDetails: "RERA सत्यापन विवरण", reraTooltipKicker: "राज्य/केंद्रशासित प्रदेश अथॉरिटी रिकॉर्ड (नमूना)", reraTooltipCopy: "सत्यापित बैज के लिए संपत्ति के लागू RERA प्राधिकरण से registration, promoter, project और status का मेल ज़रूरी है। असमर्थित प्राधिकरण unverified रहते हैं।",
      ...
      dialogTitle: "इस घर के बारे में पूछें", dialogCopy: "आपका message verified partner को जाएगा। आपका phone number तब तक masked रहेगा जब तक आप share न करें।", name: "आपका नाम", phone: "फ़ोन (masked रहेगा)", message: "संदेश", send: "Query भेजें", sending: "भेज रहे हैं…", noRealMessage: "Concept preview — lead API contract के ज़रिए stored.", consentText: "मैं सहमत हूँ कि Architech इस enquiry को store करे, मेरा phone default रूप से masked रखे, और इसे केवल इस listing के verified partner से share करे।", querySent: "Query Nivasa Partners को भेजी गई", querySentDescription: "वे आमतौर पर 4 working hours में जवाब देते हैं। आपका number masked रहता है। (डेमो)", queryFailed: "Query भेजी नहीं जा सकी", queryFailedDescription: "कृपया details जाँचकर फिर कोशिश करें।", whatsappOptInText: "हाँ, इस enquiry के बारे में एक WhatsApp acknowledgement की अनुमति दें। यह campaign नहीं है, और आप मना कर सकते हैं।",
      trust: {
