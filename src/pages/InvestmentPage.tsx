"use client";
/* India-wide investment lens: editorial context + an illustrative calculator. */
...
export default function InvestmentPage() {
  return (
    <div className="bg-paper pt-[78px] text-ink">
      <section className="border-b border-ink/12 bg-night py-20 text-cream md:py-32"><div className="container grid gap-12 lg:grid-cols-[1fr_0.7fr] lg:items-end"><Reveal><p className="kicker text-ember">India investment lens · editorial</p><h1 className="display mt-6 max-w-[900px] text-[clamp(46px,8vw,110px)]">Read the city before you read the <em className="text-ember">price.</em></h1><p className="mt-7 max-w-xl text-[15px] leading-7 text-cream/70">A calm field guide to the signals behind an address: movement, supply, use, documentation, and the everyday life a locality can support.</p></Reveal><Reveal delay={120} className="border-l-2 border-ember pl-6"><Compass size={24} className="text-ember" /><p className="mt-5 font-display text-3xl">No promises. Better questions.</p><p className="mt-3 text-sm leading-6 text-cream/60">This page is general information, not individualized investment, tax, or legal advice.</p></Reveal></div></section>
