...
- **Public page** `/list-property/` (`app/list-property/page.tsx` + `src/pages/ListProperty.tsx`) explaining the 3-step source-trail process (facts → media rights → submit for review), with a strong **"Start listing"** CTA to `/broker/listings/new`.
- **Entry points:**
