...
Read [`README.md`](README.md), [`docs/architecture/normative/final-three-phase-architecture.md`](docs/architecture/normative/final-three-phase-architecture.md), [`config/governance/contracts/DOMAIN-CONTRACTS.md`](config/governance/contracts/DOMAIN-CONTRACTS.md), [`PHASE-1-IMPLEMENTATION-PLAN.md`(docs/planning/PHASE-1-IMPLEMENTATION-PLAN.md), and [`docs/runtime-activation-gates.md`](docs/runtime-activation-gates.md). Historical improvement reviews describe earlier repository states and should not override the current application or normative contracts.
