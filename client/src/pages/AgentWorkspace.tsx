"use client";
/*
  Amdavad Modern agent workspace: an architectural operating desk for source-led,
...
const deskMeta: Record<AgentSection, DeskMeta> = {
  ...
  "agent-listings": { label: "Agent inventory", role: "Partner rail", intro: "Search the wider Ahmedabad partner network while keeping source and contact rights visible.", index: "07" },
...
const sourceMeta: Record<"newspaper" | "agent-listings" | "owner-listings", { title: string; description: string; search: string }> = {
  ...
  "agent-listings": { title: "Agent inventory", description: "Search the wider Ahmedabad partner network while keeping source and contact rights visible.", search: "Project, agent, or contact number" },
