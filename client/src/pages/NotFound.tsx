    ...
    <div className="bg-paper pt-[78px] text-ink">
      <section className="container flex min-h-[80vh] flex-col items-center justify-center py-24 text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Link href="/" className="btn-sweep motion-press inline-flex items-center gap-2 bg-brick px-8 py-5 stamp !text-[12px] font-semibold text-paper"><Compass size={15} /> Back to the start</Link>
