      ...
      <section className="listing-dossier-body container grid gap-8 py-14 lg:grid-cols-[1fr_360px] md:py-20">
        <div className="listing-packet border border-ink/12 bg-card p-7">
            ...
            <section className="border border-ink/12 bg-paper/45 p-4" aria-labelledby="media-packet-title">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-[180px_1fr]">
                ...
                <div className="grid gap-4">
                  ...
                  <button type="button" onClick={() => void prepareMediaUpload()} disabled={!draftId || !mediaFile || mediaSubmitting} className="btn-sweep btn-solid touch-44 w-fit bg-night px-4 py-3 stamp !text-[11px] font-semibold text-cream disabled:cursor-not-allowed">{mediaSubmitting ? "Preparing…" : "Sign & attach media"}</button>
                </div>
              </div>
          ...
          <div className="mt-7 flex flex-wrap gap-4">
            <button onClick={() => void onDraft()} disabled={submitting} className="btn-sweep btn-solid touch-44 bg-night px-6 py-4 stamp !text-[12px] font-semibold text-cream disabled:cursor-wait">
