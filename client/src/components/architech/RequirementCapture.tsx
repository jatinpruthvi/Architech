            ...
            {status === "success" ? (
              ...
              <form onSubmit={submit} className="grid gap-7 p-5 md:grid-cols-2 md:p-8">
                <fieldset className="md:col-span-2">
                  <legend className="stamp !text-[10px] font-semibold ink-2">I want to</legend>
                ...
                <label className="stamp !text-[10px] font-semibold ink-2">City
                ...
                <label className="stamp !text-[10px] font-semibold ink-2">Property category
                ...
                <label className="stamp !text-[10px] font-semibold ink-2">Subtype
                ...
                <label className="stamp !text-[10px] font-semibold ink-2">Mobile number<input value={form.phone} onChange={(event) => update("phone", event.target.value)} placeholder="+91 00000 00000" inputMode="tel" className="mt-2 h-12 w-full border border-ink/20 bg-paper px-3 text-sm text-ink placeholder:text-ink/35 focus:border-brick focus:outline-none" /></label>
