...
export const strings = {
  en: {
    ...
    search: {
      ...
      saveSearch: "Save this search", searchSavedToast: "Search saved", searchSavedDescription: "We'll notify you when a matching home arrives. (Demo)",
  ...
  hi: {
    ...
    search: {
      ...
      emptyHelp: "कोई फ़िल्टर हटाएँ, लोकप्रिय खोज आज़माएँ, या यह खोज सहेजें — नया घर आते ही बताएँगे।", saveSearch: "यह खोज सहेजें", searchSavedToast: "खोज सहेजी गई", searchSavedDescription: "मेल खाता घर आने पर हम सूचित करेंगे। (डेमो)",
